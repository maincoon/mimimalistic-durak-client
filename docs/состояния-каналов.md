...
state "Вспомогательные" as Utils {
  state CHAT
  state WATCH
  state SUBSCRIBED
}

state "Матчинг (Поиск)" as Matchmaking {
  state FIND
  state BEGIN
  state OKBEGIN
...
state "Посадка за стол" as Seating {
  state TAKETURN
  state TAKEPLACE
...
FREE -[#blue]-> CHAT : <color:blue>E1</color>
CHAT -[#red]-> FREE : <color:red>E13</color>

FREE -[#blue]-> WATCH : <color:blue>E17</color>
WATCH -[#red]-> FREE : <color:red>E18</color>

FREE -[#blue]-> SUBSCRIBED : <color:blue>E15</color>
SUBSCRIBED -[#red]-> FREE : <color:red>E16</color>

' Transitions FREE <-> Matchmaking
FREE -[#blue]-> FIND : <color:blue>E2</color>
FIND -[#red]-> FREE : <color:red>E12</color>

' Transitions Matchmaking -> Game
OKBEGIN --> GAME : E6

' Transitions FREE <-> Seating
FREE -[#blue]-> TAKETURN : <color:blue>E20</color>
TAKETURN -[#red]-> FREE : <color:red>E23</color>

FREE -[#blue]-> TAKEPLACE : <color:blue>E19</color>
TAKEPLACE -[#red]-> FREE : <color:red>E23</color>

' Transitions Seating -> Game
TAKEPLACE --> GAME : E22

' Transitions FREE <-> Game
FREE -[#blue]-> GAME : <color:blue>E27</color>
GAME -[#red]-> FREE : <color:red>E23</color>
LEAVE -[#red]-> FREE : <color:red>E26</color>

' Transitions Game(revanche) -> FREE
REVANCHE -[#red]-> FREE : <color:red>E11</color>
OKREVANCHE -[#red]-> FREE : <color:red>E10</color>
@enduml
```
